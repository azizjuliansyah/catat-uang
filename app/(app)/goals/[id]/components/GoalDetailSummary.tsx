/**
 * Goal Detail Summary Component
 * Displays goal information card with gradient background (renamed from GoalHeaderCard)
 */

import { SavingGoal } from "../../types";
import { formatIDR } from "@/lib/utils/format";

interface GoalDetailSummaryProps {
  goal: SavingGoal | null;
  isLoading?: boolean;
}

export function GoalDetailSummary({ goal, isLoading = false }: GoalDetailSummaryProps) {
