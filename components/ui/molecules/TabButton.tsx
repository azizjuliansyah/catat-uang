...
export function TabButton({
  ...
  const baseClasses =
    "inline-flex items-center justify-center font-sans text-sm font-medium transition-all duration-200 cursor-pointer focus:outline-none py-2 px-4 select-none";
